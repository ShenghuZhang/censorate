      ...
      <div className="flex items-center justify-between max-w-full">
        <div className="flex items-center gap-4">
          <button
            ...
            className="lg:hidden p-2 hover:bg-gray-100 rounded-xl transition-colors focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2"
          >
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 hover:bg-gray-100 rounded-xl transition-colors group focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2"
            >
        ...
        <div className="flex items-center gap-2">
          <div className="hidden md:flex items-center bg-gray-100 rounded-xl px-3 py-2">
            ...
            <input
              type="text"
              placeholder="Search..."
              aria-label="Search projects and requirements"
              className="bg-transparent border-none outline-none text-sm text-gray-700 placeholder-gray-500 w-44 focus:ring-2 focus:ring-blue-400 rounded-md"
            />
          </div>
          ...
          <div className="relative">
            <button
              ...
              className="p-2.5 hover:bg-gray-100 rounded-xl transition-colors relative focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2"
            >
          ...
          {/* Help Icon */}
          <button aria-label="Get help and documentation" className="p-2.5 hover:bg-gray-100 rounded-xl transition-colors focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2">
          ...
          <div className="relative pl-2">
            <button
              ...
              className="flex items-center gap-3 px-2 py-1.5 hover:bg-gray-100 rounded-xl transition-colors focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2"
            >
